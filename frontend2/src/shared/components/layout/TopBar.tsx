    ...
    <header className="px-6 py-4 z-[100] premium-glass border-b topbar-header">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3 items-center">
          <div className="flex items-center gap-2.5 px-4 py-2 rounded-xl topbar-wallet-container">
            ...
            <span className="text-sm font-semibold text-white tracking-wide">
              {(user?.availableCredits ?? 0).toLocaleString()}
            </span>
          </div>
          <button
            onClick={() => {
            ...
            className="text-[#f5f5f5]/70 hover:text-white transition-colors p-2 rounded-lg border border-transparent hover:border-white/10"
            aria-label="Sign out"
          >
            <LogOut size={18} />
          </button>
